...
final class Role
{
    ...
    public const string ROLE_APP_CAN_EDIT_DESCRIPTION = 'ROLE_APP_CAN_EDIT_DESCRIPTION';
    ...
    public static function getList(): array
    {
        return [
            ...
            'user.roles.role_app_can_edit_description' => self::ROLE_APP_CAN_EDIT_DESCRIPTION,
        ];
    }
}
