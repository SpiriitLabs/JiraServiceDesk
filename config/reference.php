 ...
 *     },
 *     where_method?: scalar|null|Param, // Defined the doctrine query builder method the bundle will use to add the entire filter condition. // Default: "and"
 *     condition_pattern?: scalar|null|Param, // Default condition pattern for TextFilterType // Default: "text.starts"
 *     force_case_insensitivity?: bool|Param, // Whether to do case insensitive LIKE comparisons. // Default: false
 *     encoding?: scalar|null|Param, // Encoding for case insensitive LIKE comparisons. // Default: null
 * }
 ...
 *     }>,
 * }
 * @psalm-type SpiriitAuthLogConfig = array{
 *     messenger?: scalar|null|Param, // Enables integration with symfony/messenger if set true. // Default: false
 *     transports: array{
 *         mailer?: scalar|null|Param, // Default: "mailer"
 *         sender_email: scalar|null|Param,
 *         sender_name: scalar|null|Param,
 *     },
 *     location?: array{
 *         provider?: scalar|null|Param, // Default: null
 *         geoip2_database_path?: scalar|null|Param, // Default: null
 *     },
 * }
 ...
 *     spiriit_auth_log?: SpiriitAuthLogConfig,
 *     "when@dev"?: array{
 *         imports?: ImportsConfig,
 *         parameters?: ParametersConfig,
 *         services?: ServicesConfig,
